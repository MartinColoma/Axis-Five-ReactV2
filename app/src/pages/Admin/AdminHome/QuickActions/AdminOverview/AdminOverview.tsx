...
const AdminOverview: React.FC = () => {
  ...
  const handleSaveEdit = async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`${API_BASE_URL}/api/admin/dashboard/users/${editFormData.user_id}`, {
        method: 'PUT',
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
  ...
  const handleConfirmDelete = async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`${API_BASE_URL}/api/admin/dashboard/users/${userToDelete.id}`, {
        method: 'DELETE',
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
